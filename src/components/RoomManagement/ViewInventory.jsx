            ...
            <>
                <div className="addinventory">
                    ...
                    <Breadcrumbs className="bread-link-sec" aria-label="breadcrumb">
                        ...
                        <Link color="inherit" href="/ViewTariff">View Tariff</Link>
                        <Link color="inherit" href="/AddInventory">Add Inventory</Link>
                        <Link color="inherit" href="/ViewInventory">View Inventory</Link>
                    </Breadcrumbs>

                    {/* =============BREAD CRUMBS SECTION CODE START==================== */}
                    <div>
                        <h5 className="mb-3">View Inventory</h5>
